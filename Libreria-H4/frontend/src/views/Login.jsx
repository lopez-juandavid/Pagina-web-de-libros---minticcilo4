...
export default function Login() {
    ...
    const login = async(e) => {
        ...
        const respuesta = await Axios.post('/login', usuario);
                        ...
                        <div className="card-header" >
                            ...
                            <Form onSubmit={login}>
                                <Form.Group className="mb-2" controlId="formBasicEmail">
                                    ...
                                    <Form.Control type="text" placeholder="Ingrese su número de identificación" onChange={(e)=>setCedula(e.target.value)} />
                                </Form.Group>
